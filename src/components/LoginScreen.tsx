      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="glass-card p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={login}
              className="w-full py-3 px-4 rounded-xl bg-white hover:bg-gray-100 transition-colors text-gray-800 font-medium text-sm flex items-center justify-center gap-3"
            >
            ...
            <button
              onClick={login}
              className="w-full py-3 px-4 rounded-xl bg-black hover:bg-gray-900 border border-white/10 transition-colors text-white font-medium text-sm flex items-center justify-center gap-3"
            >
