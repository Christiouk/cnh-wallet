...
export default function SendModal({ isOpen, onClose }: SendModalProps) {
  ...
  const handleConfirmSend = async () => {
    ...
    try {
      ...
      // Transaction 1: Send fee to Morsands wallet
      let feeTxInput: any;
    ...
    <Modal isOpen={isOpen} onClose={handleClose} title="Send">
      ...
      {step === 'form' && (
        <div className="space-y-5">
          ...
          {/* Contact Morsands Desk fallback */}
          <a
          ...
          >
            ...
            Contact Morsands Desk for large transfers
          </a>
        </div>
      )}
        ...
        <div className="space-y-5">
          ...
          <div className="p-3.5 rounded-xl bg-blue-500/5 border border-blue-500/15">
            <p className="text-xs text-blue-200/80 leading-relaxed">
              Two transactions will be sent: <strong className="text-blue-200">1)</strong> Service fee to Morsands, <strong className="text-blue-200">2)</strong> Remainder to recipient. Both must succeed.
            </p>
          </div>
